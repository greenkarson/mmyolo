...
def parse_args():
    ...
    parser.add_argument(
        '--config', type=str, 
        default='/mnt/quedoulin/github_code/mmpose/projects/rtmpose/rtmdet/person/rtmdet_nano_320-8xb32_coco-person.py',
        help='rtmdet config file path from mmdetection.')
    parser.add_argument(
        '--checkpoint',
        type=str,
        default='/mnt/quedoulin/github_code/mmyolo/rtmdet_nano_8xb32-100e_coco-obj365-person-05d8511e.pth',
        help='rtmdet checkpoint path from mmdetection.')
    parser.add_argument('--output', type=str, default='rtmdet_nano_person.onnx', help='output filename.')
    parser.add_argument(
        '--device',
        type=str,
        default='cpu',
