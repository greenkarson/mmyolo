...
def parse_args():
    ...
    parser.add_argument(
        '--config', type=str, 
        default='/mnt/quedoulin/github_code/mmdetection/configs/rtmdet/rtmdet_tiny_8xb32-300e_coco.py',
        help='rtmdet config file path from mmdetection.')
    parser.add_argument(
        '--checkpoint',
        type=str,
        default='/mnt/quedoulin/github_code/mmdetection/rtmdet_tiny_8xb32-300e_coco_20220902_112414-78e30dcc.pth',
        help='rtmdet checkpoint path from mmdetection.')
    parser.add_argument('--output', type=str, default='rtmdet_tiny_8xb32-300e_coco.onnx', help='output filename.')
    parser.add_argument(
        '--device',
        type=str,
        default='cpu',
