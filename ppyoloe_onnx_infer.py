...
def predict():
    img_path = '/mnt/quedoulin/github_code/yolov5/data/images/bus.jpg'
    model_file = '/mnt/quedoulin/github_code/mmyolo/ppyoloe_plus_s_fast.onnx'
    # model_file = '/mnt/public_dir/model_weights/PersonPose/PersonPose_YOLOv8m_640-b1-fp32.onnx'
    NUM_CLASSES = 80
    ...
    for i in range(1):
        ...
        cv2.imwrite('ppyoloe_test_infer.jpg', img)
